...
@AllArgsConstructor
@NoArgsConstructor
@Table(name="passes_person")
@Schema(name = "Пропуск физических лиц")
public class PassPerson {
    ...
    public PassPerson(Person person, String passGroup, LocalDateTime validUntil, String cardUID, Integer cardNo,
                      String ciphers, String allowedFacilities) {
        this.id = sequence++;
        this.person = person;
